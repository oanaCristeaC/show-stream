  ...
  <div class="container mx-auto p-4">
    <div class="flex flex-col lg:flex-row">
      ...
      <div class="flex-1 lg:w-2/3 p-4">
        ...
        <div class="flex">
          ...
          <img
            v-else-if="showDetails?.image.medium"
          ...
          <div>
            <div class="text-lg mb-4" v-html="showDetails?.summary"></div>
            <a
              target="blank"
      ...
      <div class="lg:w-1/3 p-4 bg-gray-100 rounded-lg shadow-lg">
        ...
        <p v-if="showDetails?.webChannel">
          <strong>Web channel:</strong> {{ showDetails.webChannel }}
        </p>
        <p v-if="showDetails?.schedule">
          <strong>Schedule:</strong> {{ showDetails.schedule?.days[0] }} at
        ...
        <p v-if="showDetails?.genres?.length">
          <strong>Genres:</strong> {{ showDetails?.genres.join(' | ') }}
        </p>
        <p v-if="showEpisodeList?.length > 0">
          <strong>Episodes ordered:</strong> {{ showEpisodeList?.length }} episodes
        </p>
        <p v-if="showDetails?.officialSite">
          <strong>Official site:</strong>
          <a href="https://www.amazon.com" class="text-blue-500">www.amazon.com</a>
        </p>
        <div class="mt-4">
    ...
    <div class="mt-8" v-if="showEpisodeList?.length > 0">
      ...
      <table class="min-w-full bg-white">
        ...
        <tbody>
          <tr v-for="(episode, index) in showEpisodeList" :key="index" class="border-t">
            <td class="py-2 px-4">
